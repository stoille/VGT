		...
		if(varStr != "" ){
			...
			for (var j = 1; j < goPathPairs.length; j++) {
				...
				if (varMap[varName] == undefined) {
					...
					varData.push( go );
					varMap[varName] = varData.length - 1;
